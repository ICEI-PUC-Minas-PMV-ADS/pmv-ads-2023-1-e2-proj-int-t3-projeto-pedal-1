...
namespace projetoWebPedal.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Altura,login,Senha,Perfil")] Usuario usuario)
        {
        ...
        [ValidateAntiForgeryToken]
        [AllowAnonymous]
        public async Task<IActionResult> NovoUsuario([Bind("Id,Nome,Email,Altura,login,Senha,Perfil")] Usuario usuario)
        {
            int valor = 1;
            usuario.Perfil = (Perfil)(int)valor;
            if (ModelState.IsValid)
            {
                usuario.Senha = BCrypt.Net.BCrypt.HashPassword(usuario.Senha);
                _context.Add(usuario);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Altura,login,Senha,Perfil")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
